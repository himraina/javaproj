...
System.getProperties().put("proxyPort", "8080");
 ...
 //  System.out.println("select link from mainlink where query_id="+"'"+query+"'");
	...
	r2=stmt1.executeQuery("select * from querry_string where query_id="+"'"+URLEncoder.encode(query)+"'");
	r2.next();
	String tle=r2.getString("query_id");
	...
	String fn[]={"c:\\java\\a1.txt","c:\\java\\a2.txt","c:\\java\\a3.txt","c:\\java\\a4.txt","c:\\java\\a5.txt","c:\\java\\a6.txt","c:\\java\\a7.txt","c:\\java\\a8.txt","c:\\java\\a9.txt","c:\\java\\a10.txt","c:\\java\\a11.txt","c:\\java\\a12.txt","c:\\java\\a13.txt","c:\\java\\a14.txt","c:\\java\\a15.txt","c:\\java\\a16.txt","c:\\java\\a17.txt","c:\\java\\a18.txt","c:\\java\\a19.txt","c:\\java\\a20.txt","c:\\java\\a21.txt","c:\\java\\a22.txt","c:\\java\\a23.txt","c:\\java\\a24.txt","c:\\java\\a25.txt"};
	String fon[]={"c:\\java\\b1.txt","c:\\java\\b2.txt","c:\\java\\b3.txt","c:\\java\\b4.txt","c:\\java\\b5.txt","c:\\java\\b6.txt","c:\\java\\b7.txt","c:\\java\\b8.txt","c:\\java\\b9.txt","c:\\java\\b10.txt","c:\\java\\b11.txt","c:\\java\\b12.txt","c:\\java\\b13.txt","c:\\java\\b14.txt","c:\\java\\b15.txt","c:\\java\\b16.txt","c:\\java\\b17.txt","c:\\java\\b18.txt","c:\\java\\b19.txt","c:\\java\\b20.txt","c:\\java\\b21.txt","c:\\java\\b22.txt","c:\\java\\b23.txt","c:\\java\\b24.txt","c:\\java\\b25.txt"};
	
	int i=0,j=0;
	//r.next();
	//System.out.println(r.getString("link"));
	while(r.next())
	{
		String temp = r.getString(1);
		System.out.println(temp);
//		String ss=r.getString(1);
		rk a = new rk(temp,tle,kw,fn[i++],fon[j++]);
		//r1 a = new r1();
...
System.out.println("after");
   ...
   class rk implements Runnable
    ...
    Thread t ;
     ...
     //public r1()
	 public rk(String st11,String title,String[] kw1,String st55,String st66 )
		{
	...
	public void run()
	 ...
	 try{
		System.out.println("in theread");
	//	u=r.getString("link");
		Connection conn4 = null;
		Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");                                                                                
    	conn4 = DriverManager.getConnection("jdbc:odbc:search"); 
...
FileInputStream fin=new FileInputStream(asd);
...
String content="";
     ...
     FileOutputStream out2=new FileOutputStream(osd);
...
FileInputStream fin1=new FileInputStream(osd);
...
System.out.println("total Ranking11"+total);
System.out.println("total Ranking11"+total);
System.out.println("total Ranking11"+total);
System.out.println("total Ranking11"+total);
/////////////////////////////////
...
String sq="insert into linkvalue values('"+u+"','"+head+"','"+title+"','"+h1[0]+"','"+h1[1]+"','"+h2[0]+"','"+h2[1]+"','"+h2[2]+"','"+h3[0]+"','"+h3[1]+"','"+h3[2]+"','"+URLEncoder.encode(str5)+"','"+total+"','"+query11+"')";
