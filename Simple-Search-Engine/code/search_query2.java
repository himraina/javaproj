...
import java.util.*;
public class search_query2 extends HttpServlet
{
            ...
            throws ServletException, IOException
   {
     ...
     // out.println(msec1);
      ...
      out.println("<IMG SRC=\"lol.gif\" width=270 height=90 >");
	  ...
	  out.println("<form name=neeraj method=get action=http://127.0.0.1:8080/servlet/search_query2><FONT SIZE=2 COLOR=\"#C0C000\" FACE=\"verdana\"><b>SEARCH FOR:</b></FONT><IMG SRC=\"c:\\java\\space.gif\" width=15 height=1 ><input type=text name=srchval value=\""+title+"\" ");
	 // out.println(query);
	  out.println(" size=40 maxlength=2048>&nbsp;&nbsp;<input type=\"image\" src=\"search.gif\" width=48 height=20 align=\"absmiddle\">");
...
out.println("<br><font color=white> These stop words are not included in ranking <b><font color=red>"+rem+"</b></font></font>");		
	...
	r3=stmt3.executeQuery("select * from linkvalue  where linkvalue.query="+"'"+q+"'"+" order by rank desc");
