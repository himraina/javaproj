...
public class search1 extends HttpServlet
{
            ...
            throws ServletException, IOException
   {
      ...
      String query = request.getParameter("srchval1");
      out.println("<html>");
	  ...
	  out.println("<form name=neeraj method=get action=http://127.0.0.1:8080/servlet/search1><FONT SIZE=2 COLOR=\"#C0C000\" FACE=\"verdana\"><b>SEARCH FOR:</b></FONT><IMG SRC=\"c:\\java\\space.gif\" width=15 height=1 ><input type=text name=srchval value=\""+query+"\" ");
	 // out.println(query);
...
out.println("<form method=get name=singh action=http://127.0.0.1:8080/servlet/search><FONT SIZE=2 COLOR=\"#C0C000\" FACE=\"verdana\"><b>SEARCH FOR:</b></FONT><IMG SRC=\"c:\\java\\space.gif\" width=15 height=1 ><input type=text name=srchval value=\""+query+"\" ");
